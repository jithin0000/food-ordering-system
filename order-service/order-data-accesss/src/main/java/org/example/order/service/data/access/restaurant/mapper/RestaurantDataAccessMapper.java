package org.example.order.service.data.access.restaurant.mapper;
...
import org.example.order.service.data.access.restaurant.exceptions.RestaurantDataAccessException;
...
public class RestaurantDataAccessMapper {
    ...
    {
        RestaurantEntity restaurantEntity = restaurantEntities.stream().findFirst().orElseThrow(() -> new RestaurantDataAccessException(
